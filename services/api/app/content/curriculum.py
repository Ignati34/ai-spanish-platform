...
from app.content.curriculum_b1_full import B1_FULL  # noqa: E402
_upgB1 = {l['n'] for l in B1_FULL}
CURRICULUM = [l for l in CURRICULUM if l.get('n') not in _upgB1] + B1_FULL

from app.content.curriculum_b1_full2 import B1_FULL_2  # noqa: E402
_upgB1_2 = {l['n'] for l in B1_FULL_2}
CURRICULUM = [l for l in CURRICULUM if l.get('n') not in _upgB1_2] + B1_FULL_2

from app.content.curriculum_b1_full3 import B1_FULL_3  # noqa: E402
_upgB1_3 = {l['n'] for l in B1_FULL_3}
CURRICULUM = [l for l in CURRICULUM if l.get('n') not in _upgB1_3] + B1_FULL_3

from app.content.curriculum_b2_full import B2_FULL  # noqa: E402
_upgB2 = {l['n'] for l in B2_FULL}
CURRICULUM = [l for l in CURRICULUM if l.get('n') not in _upgB2] + B2_FULL

from app.content.curriculum_b2_full2 import B2_FULL_2  # noqa: E402
_upgB2_2 = {l['n'] for l in B2_FULL_2}
CURRICULUM = [l for l in CURRICULUM if l.get('n') not in _upgB2_2] + B2_FULL_2

from app.content.curriculum_c1_full import C1_FULL  # noqa: E402
_upgC1 = {l['n'] for l in C1_FULL}
CURRICULUM = [l for l in CURRICULUM if l.get('n') not in _upgC1] + C1_FULL

from app.content.curriculum_c1_full2 import C1_FULL_2  # noqa: E402
_upgC1_2 = {l['n'] for l in C1_FULL_2}
CURRICULUM = [l for l in CURRICULUM if l.get('n') not in _upgC1_2] + C1_FULL_2

from app.content.curriculum_c2_full import C2_FULL  # noqa: E402
_upgC2 = {l['n'] for l in C2_FULL}
CURRICULUM = [l for l in CURRICULUM if l.get('n') not in _upgC2] + C2_FULL

from app.content.curriculum_c2_full2 import C2_FULL_2  # noqa: E402
_upgC2_2 = {l['n'] for l in C2_FULL_2}
CURRICULUM = [l for l in CURRICULUM if l.get('n') not in _upgC2_2] + C2_FULL_2

from app.content.curriculum_theory_expand1 import THEORY_EXPAND_1  # noqa: E402
for _l in CURRICULUM:
