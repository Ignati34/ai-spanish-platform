...
const resources = {
  ru: { translation: {
    ...
    analyzer: { title: 'Анализ текста', placeholder: 'Вставьте испанский текст…', run: 'Разобрать', verbs: 'Глаголы', nouns: 'Существительные', tenses: 'Времена', topics: 'Темы грамматики', running: 'Разбираем…', translation: 'Перевод текста', adjectives: 'Прилагательные', adverbs: 'Наречия', summary: 'Кратко', vocabulary: 'Словарь', tenseHint: 'наведите для объяснения', subtitle: 'Вставьте текст, загрузите файл (в т.ч. аудио/видео) или дайте ссылку — получите разбор.', tabText: 'Текст', tabFile: 'Файл', tabUrl: 'Ссылка', fileHint: 'PDF, DOCX, TXT, HTML, а также аудио/видео (MP3, WAV, MP4…) — расшифруем.', urlPlaceholder: 'https://… или ссылка на Google Docs', urlHint: 'Веб-страница или Google-документ (доступ «всем, у кого есть ссылка»).', sourceText: 'Исходный текст' },
  ...
  uk: { translation: {
    ...
    analyzer: { title: 'Аналіз тексту', placeholder: 'Вставте іспанський текст…', run: 'Розібрати', verbs: 'Дієслова', nouns: 'Іменники', tenses: 'Часи', topics: 'Теми граматики', running: 'Розбираємо…', translation: 'Переклад тексту', adjectives: 'Прикметники', adverbs: 'Прислівники', summary: 'Стисло', vocabulary: 'Словник', tenseHint: 'наведіть для пояснення', subtitle: 'Вставте текст, завантажте файл (зокрема аудіо/відео) або дайте посилання — отримайте розбір.', tabText: 'Текст', tabFile: 'Файл', tabUrl: 'Посилання', fileHint: 'PDF, DOCX, TXT, HTML, а також аудіо/відео (MP3, WAV, MP4…) — розшифруємо.', urlPlaceholder: 'https://… або посилання на Google Docs', urlHint: 'Вебсторінка або Google-документ (доступ «усім, хто має посилання»).', sourceText: 'Вихідний текст' },
  ...
  ar: { translation: {
    ...
    analyzer: { title: 'تحليل النص', placeholder: 'ألصق نصًا إسبانيًا…', run: 'حلّل', verbs: 'الأفعال', nouns: 'الأسماء', tenses: 'الأزمنة', topics: 'قواعد', running: 'جارٍ التحليل…', translation: 'ترجمة النص', adjectives: 'الصفات', adverbs: 'الظروف', summary: 'ملخّص', vocabulary: 'المفردات', tenseHint: 'مرّر للشرح', subtitle: 'ألصق نصًا، ارفع ملفًا (بما في ذلك صوت/فيديو) أو أدخل رابطًا — واحصل على التحليل.', tabText: 'نص', tabFile: 'ملف', tabUrl: 'رابط', fileHint: 'PDF وDOCX وTXT وHTML، وكذلك صوت/فيديو (MP3, WAV, MP4…) — سنفرّغه.', urlPlaceholder: 'https://… أو رابط Google Docs', urlHint: 'صفحة ويب أو مستند Google (متاح «لأي شخص لديه الرابط»).', sourceText: 'النص الأصلي' },
  ...
  fr: { translation: {
    ...
    analyzer: { title: 'Analyse de texte', placeholder: 'Collez un texte espagnol…', run: 'Analyser', verbs: 'Verbes', nouns: 'Noms', tenses: 'Temps', topics: 'Points de grammaire', running: 'Analyse…', translation: 'Traduction du texte', adjectives: 'Adjectifs', adverbs: 'Adverbes', summary: 'Résumé', vocabulary: 'Vocabulaire', tenseHint: 'survolez pour l’explication', subtitle: 'Collez un texte, importez un fichier (audio/vidéo compris) ou donnez un lien — obtenez l’analyse.', tabText: 'Texte', tabFile: 'Fichier', tabUrl: 'Lien', fileHint: 'PDF, DOCX, TXT, HTML, ainsi qu’audio/vidéo (MP3, WAV, MP4…) — transcrits.', urlPlaceholder: 'https://… ou un lien Google Docs', urlHint: 'Page web ou document Google (accès « tous ceux qui ont le lien »).', sourceText: 'Texte source' },
  ...
  es: { translation: {
    ...
    analyzer: { title: 'Análisis de texto', placeholder: 'Pega un texto en español…', run: 'Analizar', verbs: 'Verbos', nouns: 'Sustantivos', tenses: 'Tiempos', topics: 'Gramática', running: 'Analizando…', translation: 'Traducción del texto', adjectives: 'Adjetivos', adverbs: 'Adverbios', summary: 'Resumen', vocabulary: 'Vocabulario', tenseHint: 'pasa el ratón para la explicación', subtitle: 'Pega un texto, sube un archivo (incluido audio/vídeo) o pon un enlace — y obtén el análisis.', tabText: 'Texto', tabFile: 'Archivo', tabUrl: 'Enlace', fileHint: 'PDF, DOCX, TXT, HTML y también audio/vídeo (MP3, WAV, MP4…) — se transcribe.', urlPlaceholder: 'https://… o un enlace de Google Docs', urlHint: 'Página web o documento de Google (acceso «cualquiera con el enlace»).', sourceText: 'Texto original' },
  ...
  en: { translation: {
    ...
    analyzer: { title: 'Text analysis', placeholder: 'Paste Spanish text…', run: 'Analyze', verbs: 'Verbs', nouns: 'Nouns', tenses: 'Tenses', topics: 'Grammar topics', running: 'Analyzing…', translation: 'Text translation', adjectives: 'Adjectives', adverbs: 'Adverbs', summary: 'Summary', vocabulary: 'Vocabulary', tenseHint: 'hover for explanation', subtitle: 'Paste text, upload a file (audio/video too) or give a link — and get the analysis.', tabText: 'Text', tabFile: 'File', tabUrl: 'Link', fileHint: 'PDF, DOCX, TXT, HTML, plus audio/video (MP3, WAV, MP4…) — transcribed.', urlPlaceholder: 'https://… or a Google Docs link', urlHint: 'A web page or Google Doc (shared as “anyone with the link”).', sourceText: 'Source text' },
...
const uploadStrings: Record<string, any> = {
  ru: { nav: { upload: 'Загрузки' }, upload: { title: 'Загрузки', subtitle: 'Файл или текст → готовый урок: анализ, карточки, упражнения.', paste: 'Вставить текст', file: 'Загрузить файл', build: 'Собрать урок', building: 'Собираем урок…', placeholder: 'Вставьте испанский текст…', drop: 'PDF, DOCX, TXT, MP3, WAV', level: 'Уровень', native: 'Родной язык', summary: 'Кратко', vocabulary: 'Слова', cards: 'Карточки', exercises: 'Упражнения', transcript: 'Транскрипт', saved: 'Урок сохранён, карточки добавлены в «Повторение».', openCourse: 'Открыть в курсе', openReview: 'К повторению', history: 'История загрузок', empty: 'Пока нет загрузок.', status_uploaded: 'загружен', status_extracted: 'текст извлечён', status_transcribed: 'расшифрован', status_lesson_ready: 'урок готов', url: 'Ссылка', urlPlaceholder: 'https://… или ссылка на Google Docs', urlHint: 'Веб-страница или Google-документ (откройте доступ «всем, у кого есть ссылка»).' } },
  uk: { nav: { upload: 'Завантаження' }, upload: { title: 'Завантаження', subtitle: 'Файл або текст → готовий урок: аналіз, картки, вправи.', paste: 'Вставити текст', file: 'Завантажити файл', build: 'Зібрати урок', building: 'Збираємо урок…', placeholder: 'Вставте іспанський текст…', drop: 'PDF, DOCX, TXT, MP3, WAV', level: 'Рівень', native: 'Рідна мова', summary: 'Стисло', vocabulary: 'Слова', cards: 'Картки', exercises: 'Вправи', transcript: 'Транскрипт', saved: 'Урок збережено, картки додано до «Повторення».', openCourse: 'Відкрити в курсі', openReview: 'До повторення', history: 'Історія завантажень', empty: 'Поки немає завантажень.', status_uploaded: 'завантажено', status_extracted: 'текст видобуто', status_transcribed: 'розшифровано', status_lesson_ready: 'урок готовий', url: 'Посилання', urlPlaceholder: 'https://… або посилання на Google Docs', urlHint: 'Вебсторінка або Google-документ (надайте доступ «усім, хто має посилання»).' } },
  ar: { nav: { upload: 'الملفات' }, upload: { title: 'استوديو الرفع', subtitle: 'ملف أو نص ← درس جاهز: تحليل وبطاقات وتمارين.', paste: 'لصق نص', file: 'رفع ملف', build: 'أنشئ الدرس', building: 'جارٍ إنشاء الدرس…', placeholder: 'ألصق نصًا إسبانيًا…', drop: 'PDF, DOCX, TXT, MP3, WAV', level: 'المستوى', native: 'اللغة الأم', summary: 'ملخّص', vocabulary: 'المفردات', cards: 'البطاقات', exercises: 'التمارين', transcript: 'النص المفرّغ', saved: 'حُفظ الدرس وأُضيفت البطاقات إلى «المراجعة».', openCourse: 'افتح في الدورة', openReview: 'إلى المراجعة', history: 'سجل الرفع', empty: 'لا رفوعات بعد.', status_uploaded: 'مرفوع', status_extracted: 'استُخرج النص', status_transcribed: 'مُفرّغ', status_lesson_ready: 'الدرس جاهز', url: 'رابط', urlPlaceholder: 'https://… أو رابط Google Docs', urlHint: 'صفحة ويب أو مستند Google (شارِكه مع «أي شخص لديه الرابط»).' } },
  fr: { nav: { upload: 'Imports' }, upload: { title: "Studio d'import", subtitle: 'Fichier ou texte → une leçon prête : analyse, cartes, exercices.', paste: 'Coller un texte', file: 'Téléverser un fichier', build: 'Créer la leçon', building: 'Création de la leçon…', placeholder: 'Collez un texte espagnol…', drop: 'PDF, DOCX, TXT, MP3, WAV', level: 'Niveau', native: 'Langue maternelle', summary: 'Résumé', vocabulary: 'Vocabulaire', cards: 'Cartes', exercises: 'Exercices', transcript: 'Transcription', saved: 'Leçon enregistrée, cartes ajoutées à « Révision ».', openCourse: 'Ouvrir dans le cours', openReview: 'Vers la révision', history: 'Historique des imports', empty: 'Aucun import pour l’instant.', status_uploaded: 'téléversé', status_extracted: 'texte extrait', status_transcribed: 'transcrit', status_lesson_ready: 'leçon prête', url: 'Lien', urlPlaceholder: 'https://… ou un lien Google Docs', urlHint: 'Page web ou document Google (partagez-le en « tous ceux qui ont le lien »).' } },
  es: { nav: { upload: 'Subidas' }, upload: { title: 'Estudio de subida', subtitle: 'Archivo o texto → una lección lista: análisis, tarjetas, ejercicios.', paste: 'Pegar texto', file: 'Subir archivo', build: 'Crear lección', building: 'Creando la lección…', placeholder: 'Pega un texto en español…', drop: 'PDF, DOCX, TXT, MP3, WAV', level: 'Nivel', native: 'Lengua materna', summary: 'Resumen', vocabulary: 'Vocabulario', cards: 'Tarjetas', exercises: 'Ejercicios', transcript: 'Transcripción', saved: 'Lección guardada, tarjetas añadidas a «Repaso».', openCourse: 'Abrir en el curso', openReview: 'Ir a repaso', history: 'Historial de subidas', empty: 'Aún no hay subidas.', status_uploaded: 'subido', status_extracted: 'texto extraído', status_transcribed: 'transcrito', status_lesson_ready: 'lección lista', url: 'Enlace', urlPlaceholder: 'https://… o un enlace de Google Docs', urlHint: 'Página web o documento de Google (compártelo como «cualquiera con el enlace»).' } },
  en: { nav: { upload: 'Uploads' }, upload: { title: 'Upload Studio', subtitle: 'A file or text → a ready lesson: analysis, flashcards, exercises.', paste: 'Paste text', file: 'Upload file', build: 'Build lesson', building: 'Building lesson…', placeholder: 'Paste Spanish text…', drop: 'PDF, DOCX, TXT, MP3, WAV', level: 'Level', native: 'Native language', summary: 'Summary', vocabulary: 'Vocabulary', cards: 'Flashcards', exercises: 'Exercises', transcript: 'Transcript', saved: 'Lesson saved, cards added to Review.', openCourse: 'Open in course', openReview: 'Go to review', history: 'Upload history', empty: 'No uploads yet.', status_uploaded: 'uploaded', status_extracted: 'text extracted', status_transcribed: 'transcribed', status_lesson_ready: 'lesson ready', url: 'Link', urlPlaceholder: 'https://… or a Google Docs link', urlHint: 'A web page or Google Doc (share it as “anyone with the link”).' } }
};
...
const courseStrings: Record<string, any> = {
  ru: { progress: { words: 'Слова с примерами' }, course: { subtitle: 'Ваши уроки по уровням. Новые появляются из «Загрузок».', back: 'Назад', theoryLang: 'Язык теории', translating: 'переводим…', theory: 'Теория', words: 'Слова', exercises: 'Упражнения', lessons: 'уроков', none: 'нет уроков', empty: 'В этом уроке пока нет карточек.', buildHint: 'Пока нет уроков этого уровня — соберите урок в «Загрузках».', subtitleShort: '' } },
  uk: { progress: { words: 'Слова з прикладами' }, course: { subtitle: 'Ваші уроки за рівнями. Нові зʼявляються із «Завантажень».', back: 'Назад', theoryLang: 'Мова теорії', translating: 'перекладаємо…', theory: 'Теорія', words: 'Слова', exercises: 'Вправи', lessons: 'уроків', none: 'немає уроків', empty: 'У цьому уроці ще немає карток.', buildHint: 'Поки немає уроків цього рівня — зберіть урок у «Завантаженнях».' } },
  ar: { progress: { words: 'كلمات مع أمثلة' }, course: { subtitle: 'دروسك حسب المستوى. تظهر الجديدة من «التحميلات».', back: 'رجوع', theoryLang: 'لغة الشرح', translating: 'جارٍ الترجمة…', theory: 'النظرية', words: 'كلمات', exercises: 'تمارين', lessons: 'دروس', none: 'لا دروس', empty: 'لا بطاقات في هذا الدرس بعد.', buildHint: 'لا دروس لهذا المستوى بعد — أنشئ درسًا من «التحميلات».' } },
  fr: { progress: { words: 'Mots avec exemples' }, course: { subtitle: 'Vos leçons par niveau. Les nouvelles viennent des « Imports ».', back: 'Retour', theoryLang: 'Langue de la théorie', translating: 'traduction…', theory: 'Théorie', words: 'Mots', exercises: 'Exercices', lessons: 'leçons', none: 'aucune leçon', empty: 'Pas encore de cartes dans cette leçon.', buildHint: 'Aucune leçon à ce niveau — créez-en une dans « Imports ».' } },
  es: { progress: { words: 'Palabras con ejemplos' }, course: { subtitle: 'Tus lecciones por nivel. Las nuevas vienen de «Subidas».', back: 'Atrás', theoryLang: 'Idioma de la teoría', translating: 'traduciendo…', theory: 'Teoría', words: 'Palabras', exercises: 'Ejercicios', lessons: 'lecciones', none: 'sin lecciones', empty: 'Aún no hay tarjetas en esta lección.', buildHint: 'Aún no hay lecciones de este nivel — crea una en «Subidas».' } },
  en: { progress: { words: 'Words with examples' }, course: { subtitle: 'Your lessons by level. New ones come from Uploads.', back: 'Back', theoryLang: 'Theory language', translating: 'translating…', theory: 'Theory', words: 'Words', exercises: 'Exercises', lessons: 'lessons', none: 'no lessons', empty: 'No cards in this lesson yet.', buildHint: 'No lessons at this level yet — build one in Uploads.' } }
};
...
const dialoguesStrings: Record<string, any> = {
  ru: { nav: { dialogues: 'Диалоги' }, dialogues: { title: 'Диалоги', subtitle: 'Готовые диалоги по уровням — от простых к сложным — и генератор своих на любую тему.', level: 'Уровень', generateTitle: 'Свой диалог на тему', topicPlaceholder: 'Тема диалога (например: «В аэропорту», «Спор о планах»)…', generate: 'Сгенерировать', generating: 'Генерируем…', charsLeft: 'осталось {{n}} символов', builtin: 'Готовые диалоги', loading: 'Загружаем…', empty: 'Нет диалогов для этого уровня.', stubNote: 'Демо-режим: задайте AI_PROVIDER=openai и AI_API_KEY для настоящей генерации.' } },
  uk: { nav: { dialogues: 'Діалоги' }, dialogues: { title: 'Діалоги', subtitle: 'Готові діалоги за рівнями — від простих до складних — і генератор власних на будь-яку тему.', level: 'Рівень', generateTitle: 'Власний діалог на тему', topicPlaceholder: 'Тема діалогу (наприклад: «В аеропорту»)…', generate: 'Згенерувати', generating: 'Генеруємо…', charsLeft: 'залишилось {{n}} символів', builtin: 'Готові діалоги', loading: 'Завантажуємо…', empty: 'Немає діалогів для цього рівня.', stubNote: 'Демо-режим: задайте AI_PROVIDER=openai та AI_API_KEY для справжньої генерації.' } },
  ar: { nav: { dialogues: 'حوارات' }, dialogues: { title: 'حوارات', subtitle: 'حوارات جاهزة حسب المستوى — من الأبسط إلى الأصعب — ومولّد حوارات في أي موضوع.', level: 'المستوى', generateTitle: 'حوار خاص حول موضوع', topicPlaceholder: 'موضوع الحوار (مثال: «في المطار»)…', generate: 'أنشئ', generating: 'جارٍ الإنشاء…', charsLeft: 'بقي {{n}} حرفًا', builtin: 'حوارات جاهزة', loading: 'جارٍ التحميل…', empty: 'لا حوارات لهذا المستوى.', stubNote: 'وضع تجريبي: اضبط AI_PROVIDER=openai وAI_API_KEY للإنشاء الحقيقي.' } },
  fr: { nav: { dialogues: 'Dialogues' }, dialogues: { title: 'Dialogues', subtitle: 'Des dialogues gradués par niveau — du simple au complexe — et un générateur sur tout sujet.', level: 'Niveau', generateTitle: 'Votre dialogue sur un thème', topicPlaceholder: 'Thème du dialogue (ex. : « À l’aéroport »)…', generate: 'Générer', generating: 'Génération…', charsLeft: '{{n}} caractères restants', builtin: 'Dialogues prêts', loading: 'Chargement…', empty: 'Aucun dialogue pour ce niveau.', stubNote: 'Mode démo : définissez AI_PROVIDER=openai et AI_API_KEY pour une vraie génération.' } },
  es: { nav: { dialogues: 'Diálogos' }, dialogues: { title: 'Diálogos', subtitle: 'Diálogos graduados por nivel — de lo simple a lo complejo — y un generador sobre cualquier tema.', level: 'Nivel', generateTitle: 'Tu diálogo sobre un tema', topicPlaceholder: 'Tema del diálogo (p. ej.: «En el aeropuerto»)…', generate: 'Generar', generating: 'Generando…', charsLeft: 'quedan {{n}} caracteres', builtin: 'Diálogos listos', loading: 'Cargando…', empty: 'No hay diálogos para este nivel.', stubNote: 'Modo demo: define AI_PROVIDER=openai y AI_API_KEY para una generación real.' } },
  en: { nav: { dialogues: 'Dialogues' }, dialogues: { title: 'Dialogues', subtitle: 'Level-graded dialogues — simple to complex — plus a generator for any topic.', level: 'Level', generateTitle: 'Your dialogue on a topic', topicPlaceholder: 'Dialogue topic (e.g. “At the airport”)…', generate: 'Generate', generating: 'Generating…', charsLeft: '{{n}} characters left', builtin: 'Ready-made dialogues', loading: 'Loading…', empty: 'No dialogues for this level.', stubNote: 'Demo mode: set AI_PROVIDER=openai and AI_API_KEY for real generation.' } }
};
Object.entries(dialoguesStrings).forEach(([lng, bundle]) => {
  i18n.addResourceBundle(lng, 'translation', bundle, true, true);
});

const libraryStrings: Record<string, any> = {
  ru: { nav: { library: 'Библиотека' }, library: { title: 'Библиотека для чтения', subtitle: 'Тексты по уровням для чтения онлайн и скачивания, плюс проверенные онлайн-ресурсы.', reading: 'Чтение по уровням', online: 'Онлайн-ресурсы', allLevels: 'Все', read: 'Читать', open: 'Открыть', download: 'Скачать .txt', close: 'Закрыть', showTranslation: 'Показать перевод', hideTranslation: 'Скрыть перевод', loading: 'Загружаем…', empty: 'Ничего не найдено.' } },
  uk: { nav: { library: 'Бібліотека' }, library: { title: 'Бібліотека для читання', subtitle: 'Тексти за рівнями для читання онлайн і завантаження, а також перевірені онлайн-ресурси.', reading: 'Читання за рівнями', online: 'Онлайн-ресурси', allLevels: 'Усі', read: 'Читати', open: 'Відкрити', download: 'Завантажити .txt', close: 'Закрити', showTranslation: 'Показати переклад', hideTranslation: 'Сховати переклад', loading: 'Завантажуємо…', empty: 'Нічого не знайдено.' } },
  ar: { nav: { library: 'المكتبة' }, library: { title: 'مكتبة القراءة', subtitle: 'نصوص متدرّجة للقراءة أونلاين أو تنزيلها، إضافةً إلى موارد إلكترونية موثوقة.', reading: 'قراءة حسب المستوى', online: 'موارد إلكترونية', allLevels: 'الكل', read: 'اقرأ', open: 'افتح', download: 'تنزيل .txt', close: 'إغلاق', showTranslation: 'إظهار الترجمة', hideTranslation: 'إخفاء الترجمة', loading: 'جارٍ التحميل…', empty: 'لا نتائج.' } },
  fr: { nav: { library: 'Bibliothèque' }, library: { title: 'Bibliothèque de lecture', subtitle: 'Textes gradués à lire en ligne ou à télécharger, plus des ressources en ligne fiables.', reading: 'Lecture par niveau', online: 'Ressources en ligne', allLevels: 'Tous', read: 'Lire', open: 'Ouvrir', download: 'Télécharger .txt', close: 'Fermer', showTranslation: 'Voir la traduction', hideTranslation: 'Masquer la traduction', loading: 'Chargement…', empty: 'Aucun résultat.' } },
  es: { nav: { library: 'Biblioteca' }, library: { title: 'Biblioteca de lectura', subtitle: 'Textos graduados para leer en línea o descargar, además de recursos en línea fiables.', reading: 'Lectura por nivel', online: 'Recursos en línea', allLevels: 'Todos', read: 'Leer', open: 'Abrir', download: 'Descargar .txt', close: 'Cerrar', showTranslation: 'Ver traducción', hideTranslation: 'Ocultar traducción', loading: 'Cargando…', empty: 'Sin resultados.' } },
  en: { nav: { library: 'Library' }, library: { title: 'Reading library', subtitle: 'Level-graded texts to read online or download, plus trusted online resources.', reading: 'Reading by level', online: 'Online resources', allLevels: 'All', read: 'Read', open: 'Open', download: 'Download .txt', close: 'Close', showTranslation: 'Show translation', hideTranslation: 'Hide translation', loading: 'Loading…', empty: 'Nothing found.' } }
};
Object.entries(libraryStrings).forEach(([lng, bundle]) => {
  i18n.addResourceBundle(lng, 'translation', bundle, true, true);
});
