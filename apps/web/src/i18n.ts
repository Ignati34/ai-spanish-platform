...
const libraryStrings: Record<string, any> = {
  ru: { nav: { library: 'Библиотека' }, library: { title: 'Библиотека для чтения', subtitle: 'Тексты по уровням для чтения онлайн и скачивания, плюс проверенные онлайн-ресурсы.', reading: 'Чтение по уровням', online: 'Онлайн-ресурсы', allLevels: 'Все', read: 'Читать', open: 'Открыть', download: 'Скачать .txt', close: 'Закрыть', loading: 'Загружаем…', empty: 'Ничего не найдено.' } },
  uk: { nav: { library: 'Бібліотека' }, library: { title: 'Бібліотека для читання', subtitle: 'Тексти за рівнями для читання онлайн і завантаження, а також перевірені онлайн-ресурси.', reading: 'Читання за рівнями', online: 'Онлайн-ресурси', allLevels: 'Усі', read: 'Читати', open: 'Відкрити', download: 'Завантажити .txt', close: 'Закрити', loading: 'Завантажуємо…', empty: 'Нічого не знайдено.' } },
  ar: { nav: { library: 'المكتبة' }, library: { title: 'مكتبة القراءة', subtitle: 'نصوص متدرّجة للقراءة أونلاين أو تنزيلها، إضافةً إلى موارد إلكترونية موثوقة.', reading: 'قراءة حسب المستوى', online: 'موارد إلكترونية', allLevels: 'الكل', read: 'اقرأ', open: 'افتح', download: 'تنزيل .txt', close: 'إغلاق', loading: 'جارٍ التحميل…', empty: 'لا نتائج.' } },
  fr: { nav: { library: 'Bibliothèque' }, library: { title: 'Bibliothèque de lecture', subtitle: 'Textes gradués à lire en ligne ou à télécharger, plus des ressources en ligne fiables.', reading: 'Lecture par niveau', online: 'Ressources en ligne', allLevels: 'Tous', read: 'Lire', open: 'Ouvrir', download: 'Télécharger .txt', close: 'Fermer', loading: 'Chargement…', empty: 'Aucun résultat.' } },
  es: { nav: { library: 'Biblioteca' }, library: { title: 'Biblioteca de lectura', subtitle: 'Textos graduados para leer en línea o descargar, además de recursos en línea fiables.', reading: 'Lectura por nivel', online: 'Recursos en línea', allLevels: 'Todos', read: 'Leer', open: 'Abrir', download: 'Descargar .txt', close: 'Cerrar', loading: 'Cargando…', empty: 'Sin resultados.' } },
  en: { nav: { library: 'Library' }, library: { title: 'Reading library', subtitle: 'Level-graded texts to read online or download, plus trusted online resources.', reading: 'Reading by level', online: 'Online resources', allLevels: 'All', read: 'Read', open: 'Open', download: 'Download .txt', close: 'Close', loading: 'Loading…', empty: 'Nothing found.' } }
};
